...
const Destinations = () => {
  ...
  return (
    <div className="space-y-10 flex flex-col items-center">
        <div className="text-black min-h-60 w-full flex flex-col justify-center items-center py-12 px-4 bg-gradient-to-b from-[#ffd2a8] to-[#348d4300]">
      ...
      <div className="px-4 flex flex-wrap gap-3 max-md:flex-col md:justify-stretch max-w-[1300px] w-full">
        <div className="p-2 border-1 flex-1 rounded-[7px] border-neutral-200 flex items-center gap-3">
            <BiSearch className="text-[1.2rem] text-neutral-400"/>
            <input type="text" className="text-[0.9rem]" placeholder="Search destinations"/>
        </div>
